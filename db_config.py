...
from src.utils.constants import APP_NAME, DEFAULT_STATEMENT_TIMEOUT
...
def get_all_account_users_after_2022():
    with SessionManager() as db: 
        statement = text("SELECT * FROM account_users WHERE created_at > '2022-01-01T00:00:00Z';")
        results = db.execute(statement).fetchall()
    
    print("RESULTS ARE:", results)
    return results

res = get_all_account_users_after_2022()